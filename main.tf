...
resource "aws_cognito_user_pool_client" "client"{
    ...
    callback_urls = ["http://localhost:3000/oauth2/callback", "https://main.deu6lm3uucumx.amplifyapp.com/oauth2/callback", "${aws_apigatewayv2_api.auth.api_endpoint}/oauth2/callback", "https://dashboard.focaltech.site/oauth2/callback",]
    logout_urls = ["http://localhost:3000/", "https://main.deu6lm3uucumx.amplifyapp.com/", aws_apigatewayv2_api.auth.api_endpoint, "https://dashboard.focaltech.site/",]
